"""
Trains one dispatcher FC head (Linear EMBEDDING_DIM -> 4) and predicts with it. Kept
...
def train_fc(train_embeddings, train_labels, penalty_matrix, class_weights, device):
    """Returns the trained weight matrix W (4, EMBEDDING_DIM) and bias b (4,) as numpy arrays."""
