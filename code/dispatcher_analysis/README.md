...
The `alpha_sys` metric definition, why copied weight files aren't trusted, and the
majority-class-bias finding (resolved once measured under real `alpha_sys`) are
narrated in `../../Journel/Week1.md`.
