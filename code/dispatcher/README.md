...
**Does**: trains a `Linear(512→4)` FC head on frozen ResNet18 embeddings under an
...
Dispatcher methodology, the `alpha_sys` objective, class-imbalance (INS) fix, and the
three completed NSGA-II runs are narrated in `../../Journel/Week1.md`.
